/**
 * Unchanged filtering test fixtures - used for testing unchanged artifact filtering options.
 */

import { type ArtifactDiff } from "../../artifact-diff.ts";

/* Only unchanged artifacts - used to test filtering behavior */
export const unchangedOnly: ArtifactDiff[] = [
	{
		id: "lib",
		name: "lib",
		status: "updated",
...
/* Only changed artifacts - used to test when no filtering is needed */
export const allChanged: ArtifactDiff[] = [
	{
		id: "app",
		name: "app",
		status: "updated",
...
/* Mix with multiple unchanged artifacts - used to test plural messages */
export const multipleUnchanged: ArtifactDiff[] = [
	{
		id: "app",
		name: "app",
		status: "updated",
...
/* Unchanged artifacts with no compression - used for collapse view testing */
export const unchangedNoCompression: ArtifactDiff[] = [
	{
		id: "app",
		name: "app",
		status: "updated",
